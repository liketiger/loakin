...
const RaidForm = () => {
  ...
  return (
    <RaidFormWrapper>
      <BtnWrapper>
        <RaidFormSelectBtn theme={themeHandler} onClick={selectCreateHandler} isCreate={isCreate} btnType='create'>레이드 생성</RaidFormSelectBtn>
        <RaidFormSelectBtn theme={themeHandler} onClick={selectAttendHandler} isCreate={isCreate} btnType='attend'>레이드 참가</RaidFormSelectBtn>
      </BtnWrapper>
